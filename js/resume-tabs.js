  ...
  const DATA = {
        ...
        experience: [
          { id: 'creekside', title: 'Revenue Cycle Manager', org: 'Creekside Physical Medicine', location: 'Boulder, CO', dates: 'May to Dec 2025', bullets: [
            ...
            { t: 'Audited payer-specific denial patterns and denial codes to find revenue leakage, surfacing <strong>charge capture gaps</strong> in injection administration (96372 plus J-code combinations) and coding variances corrected through modifier adjustments.', tabs: ['analyst', 'operations', 'revenue'] },
